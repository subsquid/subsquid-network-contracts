...
interface IGatewayRegistry {
    ...
    event StakeReallocated(
        address indexed fromPortal, address indexed toPortal, address indexed provider, uint256 amount
    );
    ...
    function reallocate(address fromPortal, address toPortal, address provider, uint256 amount) external;
