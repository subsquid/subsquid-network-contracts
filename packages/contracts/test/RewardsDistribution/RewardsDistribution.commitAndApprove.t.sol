...
contract RewardsDistributionCommitApproveTest is RewardsDistributionTest {
  ...
  function test_RevertsIf_ArgsLengthsShouldMatch() public {
    ...
    (, uint256[] memory workerAmounts, uint256[] memory stakerAmounts, uint256[] memory allocationsUsed) =
      prepareRewards(2);
    vm.expectRevert("Recipients and worker amounts length mismatch");
    rewardsDistribution.commit(1, 2, recipients, workerAmounts, stakerAmounts, allocationsUsed);
    vm.expectRevert("Recipients and staker amounts length mismatch");
    rewardsDistribution.commit(1, 2, recipients, correctWorkerAmounts, stakerAmounts, allocationsUsed);
  }
  ...
  function test_RevertsIf_CommittingForFutureBlock() public {
    ...
    rewardsDistribution.commit(1, 11, recipients, workerAmounts, stakerAmounts, allocationsUsed);
  }
  ...
  function test_RevertsIs_ApprovingWithWrongParams() public {
    ...
    rewardsDistribution.approve(1, 5, recipients, workerAmounts, stakerAmounts, allocationsUsed);
    vm.expectRevert("Commitment does not exist");
    rewardsDistribution.approve(2, 4, recipients, workerAmounts, stakerAmounts, allocationsUsed);
  ...
  function test_canApproveReturnsTrueIfCanApprove() public {
    ...
    rewardsDistribution.commit(1, 4, recipients, workerAmounts, stakerAmounts, allocationsUsed);
    assertEq(
      rewardsDistribution.canApprove(address(1), 1, 4, recipients, workerAmounts, stakerAmounts, allocationsUsed), true
    );
  }
  ...
  function test_canApproveReturnsTrueIfNothingWasCommitted() public {
    ...
    rewardsDistribution.addDistributor(address(1));
    assertEq(
      rewardsDistribution.canApprove(address(1), 1, 4, recipients, workerAmounts, stakerAmounts, allocationsUsed), false
    );
  }
  ...
  function test_canApproveReturnsFalseIfCommitmentMismatch() public {
    ...
    rewardsDistribution.commit(1, 4, recipients, workerAmounts, stakerAmounts, allocationsUsed);
    assertEq(
      rewardsDistribution.canApprove(address(1), 2, 4, recipients, workerAmounts, stakerAmounts, allocationsUsed), false
    );
  }
